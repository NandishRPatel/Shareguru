...
<body onLoad="change();">
	...
	<div id="signupbg">
	<br><h2 align="center" style="color:#3A3A3A;"><u>REGISTRATION FORM</u></h1><br>
						
<form action="userdb.php" name="signup" method="post">
<table align="center">
<tr>
<?php
...
<tr>
	<td>Phone no:</td>
	<td><input type="text" id="phoneno" name="phoneno" maxlength="10"  ></td>
</tr>
<tr>
	<td>Email Id:</td>
...
<tr>
	...
	<td><input type="text"  id="uname" name="uname" maxlength="18"></td>
</tr>
...
<tr>
	...
	<td><input type="password"  id="cpwd" maxlength="15" ></td>
</tr>
<tr>
	<td>Birthdate:</td>
...
<tr>
	...
	<td><textarea class="address" name="address" id="address" rows="10" cols="50">
	    </textarea></td>
</tr>
<tr>
	<td>Sex:</td>
	<td><input type="radio"  id="gender" name="gender" value="Male" checked> Male<br>
...
<tr>
	<td></td>
	<td colspan="1"><input type="button" class="button" value="Register!" onClick="test();"><input type="button" class="button" value="Reset" onClick="document.signup.reset();"></td>
</tr>
</table>    
</form>
</div>
