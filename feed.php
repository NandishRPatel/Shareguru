...
$q = "insert into feedback(Feed_uid,Feedback) values('".$a."','".$b."')";
//echo $q;
$r = mysqli_query($c,$q);

//$c123 = mysql_connect("localhost","root","root");
//$s123 = mysql_select_db("nandish",$c123);
$q1="select * from user where User_id='".$a."'";
//echo "<br>".$q1;
...
$mail=mail($email,"Thanks for your feedback",$msg);
 	 ...
 	 else
 {
	...
	window.location.href="Homepageu.php"
	</script>';
 }
