...
mysql_query("delete from id2444408_nandish.orderb where User_id='".$uid."' and Order_name='".$name."'");
$q5="select * from broker where User_id='".$uid."'";
$bb=mysql_query($q5);
...
header("location:BuySellSharesb.php");
?>